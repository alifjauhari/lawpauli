void RegisterAllStrippedInternalCalls()
{
	...
	//Start Registrations for type : UnityEngine.AI.NavMeshAgent
		...
		void Register_UnityEngine_AI_NavMeshAgent_get_hasPath();
		...
		void Register_UnityEngine_AI_NavMeshAgent_ResetPath();
		Register_UnityEngine_AI_NavMeshAgent_ResetPath();
		...
		void Register_UnityEngine_AI_NavMeshAgent_set_stoppingDistance();
		Register_UnityEngine_AI_NavMeshAgent_set_stoppingDistance();

		//System.Void UnityEngine.AI.NavMeshAgent::set_updatePosition(System.Boolean)
		void Register_UnityEngine_AI_NavMeshAgent_set_updatePosition();
		Register_UnityEngine_AI_NavMeshAgent_set_updatePosition();

		//System.Void UnityEngine.AI.NavMeshAgent::set_updateRotation(System.Boolean)
		void Register_UnityEngine_AI_NavMeshAgent_set_updateRotation();
		Register_UnityEngine_AI_NavMeshAgent_set_updateRotation();

		//System.Void UnityEngine.AI.NavMeshAgent::set_updateUpAxis(System.Boolean)
		void Register_UnityEngine_AI_NavMeshAgent_set_updateUpAxis();
		Register_UnityEngine_AI_NavMeshAgent_set_updateUpAxis();
